### THIS CODE HAS BEEN DIRECTLY COPIED AND MODIFIED FROM Single_ODrive_MoveRobot.py  And has some left over stuff form that file ###


'''
Run python Single_ODrive_MoveOneFlipper.py -mode calibration  for calibration
RUn python Single_ODrive_MoveOneFlipper.py					  for no calibration
'''
