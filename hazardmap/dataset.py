...
The inside of the ship was finished, as finished as a ship ever was; that could be
told in a single eye-blinking glance. No martinet in the system could have put as much
spit-and-polish into a surface as those robots had. The walls were of a gleaming silvery
finish that retained no fingerprints.
 There were no angles; walls, floors, and ceiling faded gently into each other and
in the cold, metallic glittering of the hidden lights, one was surrounded by six chilly
reflections of one’s bewildered self.
 The main corridor was a narrow tunnel that led in a hard, clatter-footed stretch
along a line of rooms of no interdistinguishing features.
 Powell said, “I suppose furniture is built into the wall. Or maybe we’re not
supposed to sit or sleep.”
 It was in the last room, the one nearest the nose, that the monotony broke. A
curving window of non-reflecting glass was the first break in the universal metal, and
below it was a single large dial, with a single motionless needle hard against the zero
mark.
 Donovan said, “Look at that!” and pointed to the single word on the finelymarked
scale.
 It said, “Parsecs” and the tiny figure at the right end of the curving, graduated
meter said “1,000,000.”
...
gingerly, and found it molded to the body’s curves, and comfortable.
 ...
 “I have looked it over. I came, I saw, I’m through!” Donovan’s red hair bristled
into separate wires, “Greg, let’s get out of here. I quit my job five seconds ago, and this is
a restricted area for non-personnel.”
 Powell smiled in an oily self-satisfied manner and smoothed his mustache, “O.K.,
Mike, turn off that adrenalin tap you’ve got draining into your bloodstream. I was
worried, too, but no more.”
 ...
 “Seems so.”
 “Take my word for it, we have. Did you see any pilot room except for this one
port and the one gauge here in parsecs? Did you see any controls?”
 “No.”
 “And did you see any engines?”
 “Holy Joe, no!”
 “Well, then! Let’s break the news to Lanning, Mike.”
 They cursed their way through the featureless corridors and finally hit-and-missed
their way into the short passage to the air lock.
 ...
 Powell said, “I didn’t see any emergency exits. If something’s gone wrong here,
they’ll have to melt us out.”
 “Yes, and we’ve got to wait until they find out that some fool has locked us in
here,” added Donovan, frantically.
 “Let’s get back to the room with the port. It’s the only place from which we might
attract attention.”
 But they didn’t.
 In that last room, the port was no longer blue and full of sky. It was black, and
hard yellow pin-point stars spelled space.
