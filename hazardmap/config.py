...
DATASET_DOWNLOAD_KEYWORDS = ["robotics competition", "indoors", "wood", "building site", "disaster interior", "disaster stairs",
                     ...
                     "people", "colourful tiles", "square pattern", ""]
...
# DATASET_NUM_IMAGES = min(len(DATASET_DOWNLOAD_KEYWORDS) * 50, DATASET_MAX_NUM_IMAGES)
# for some reason the downloader is unwilling to download more than 100 per key
